...
namespace 練習問題P141
{
    ...
    public partial class Form1 : Form
    {
        ...
        //曜日を求めるメソッド
        private int Days(int year, int month1, int day1)
        {
            int weekday;
            ...
            if (month1 == 1 || month1 == 2)
            {
                year -= 1;
                month1 += 12;
                weekday = (5 * year / 4 - year / 400 + year / 400 + (26 * 13 + 16) / 10 + day1) % 7;
            }
            else
            {
                weekday = (5 * year / 4 - year / 100 + year / 400 + (26 * month1 + 16) / 10 + day1) % 7;
            }
